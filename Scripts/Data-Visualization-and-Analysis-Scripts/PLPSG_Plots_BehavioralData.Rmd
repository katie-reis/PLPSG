...
hist(x1 , main="" , xlim=c(-0.2, 0.45), ylab="Count: sleep", xlab="", ylim=c(0,4) , xaxt="n", las=1 , col="deepskyblue4", breaks=12)
par(mar=c(5,5,0,3))
hist(x2 , main="" , xlim=c(-0.2, 0.45), ylab="Count: wake", xlab="Loss", ylim=c(4,0) , las=1 , col="indianred3"  , breaks=12)
```
...
hist(x1 , main="" , xlim=c(-0.2, 0.45), ylab="Count: sleep", xlab="", ylim=c(0,4) , xaxt="n", las=1 , col="deepskyblue4", breaks=12)
par(mar=c(5,5,0,3))
hist(x2 , main="" , xlim=c(-0.2, 0.45), ylab="Count: wake", xlab="Recovery", ylim=c(4,0) , las=1 , col="indianred3"  , breaks=12)
```
...
hist(x1 , main="" , xlim=c(-0.2, 0.45), ylab="Count: sleep", xlab="", ylim=c(0,4) , xaxt="n", las=1 , col="deepskyblue4", breaks=12)
par(mar=c(5,5,0,3))
hist(x2 , main="" , xlim=c(-0.2, 0.45), ylab="Count: wake", xlab="Maintenance", ylim=c(4,0) , las=1 , col="indianred3"  , breaks=12)
```
...
hist(x1 , main="" , xlim=c(-0.2, 0.45), ylab="Count: sleep", xlab="", ylim=c(0,4) , xaxt="n", las=1 , col="deepskyblue4", breaks=12)
par(mar=c(5,5,0,3))
hist(x2 , main="" , xlim=c(-0.2, 0.45), ylab="Count: wake", xlab="Long term recovery", ylim=c(4,0) , las=1 , col="indianred3"  , breaks=12)
```

### violin plots of retention
```{r, message= FALSE}
retentionplot = ggplot(PLPSG_sleep_stats_wider,
  aes(x = retention,
      fill = condition)) +
  ggtitle("Retention (Block 6 - Block 3)") +
    xlim(-0.15,.45) +
  geom_histogram(alpha = 0.5, position = "identity", bins = 30) + 
  scale_fill_manual(values=c("deepskyblue4", "indianred3"))
...
x1 = PLPSG_sleep_stats_wider$retention[PLPSG_sleep_stats_wider$condition == "sleep"]
x2 = PLPSG_sleep_stats_wider$retention[PLPSG_sleep_stats_wider$condition == "wake"]
par(mfrow=c(2,1))
...
hist(x1 , main="" , xlim=c(-0.2, 0.45), ylab="Count: sleep", xlab="", ylim=c(0,4) , xaxt="n", las=1 , col="deepskyblue4", breaks=12)
par(mar=c(5,5,0,3))
hist(x2 , main="" , xlim=c(-0.2, 0.45), ylab="Count: wake", xlab="Retention", ylim=c(4,0) , las=1 , col="indianred3", breaks=12)
```
