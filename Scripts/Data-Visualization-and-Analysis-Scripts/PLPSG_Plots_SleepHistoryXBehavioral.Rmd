...
```{r}
plot1 = historyplot3("nightbefore_sleep_deviation_from_norm", "N1", "Immediate Restriction", "N1 Duration (mins)",2.3,12)
plot2 = historyplot3("average_sleep_deviation_from_norm", "N1", "Cumulative Restriction", "N1 Duration (mins)",2.0,13)
plot3 = historyplot3("nightbefore_sleep_deviation_from_norm", "perN1", "Immediate Restriction", "N1 (% of TST)",2.3,15)
plot4 = historyplot3("average_sleep_deviation_from_norm", "perN1", "Cumulative Restriction", "N1 (% of TST)",2.0,17)
...
```{r}
plot1 = historyplot3("nightbefore_sleep_deviation_from_norm", "N2", "Immediate Restriction", "N2 Duration (mins)",2.3,26)
plot2 = historyplot3("average_sleep_deviation_from_norm", "N2", "Cumulative Restriction", "N2 Duration (mins)",2.0,24)
plot3 = historyplot3("nightbefore_sleep_deviation_from_norm", "perN2", "Immediate Restriction", "N2 (% of TST)",2.3,38)
plot4 = historyplot3("average_sleep_deviation_from_norm", "perN2", "Cumulative Restriction", "N2 (% of TST)",2.0,30)
...
```{r}
plot1 = historyplot3("nightbefore_sleep_deviation_from_norm", "N3", "Immediate Restriction", "SWS Duration (mins)",2.3,29)
plot2 = historyplot3("average_sleep_deviation_from_norm", "N3", "Cumulative Restriction", "SWS Duration (mins)",2.0,37)
plot3 = historyplot3("nightbefore_sleep_deviation_from_norm", "perN3", "Immediate Restriction", "SWS (% of TST)",2.3,38)
plot4 = historyplot3("average_sleep_deviation_from_norm", "perN3", "Cumulative Restriction", "SWS (% of TST)",2.0,47)
...
```{r}
plot1 = historyplot3("nightbefore_sleep_deviation_from_norm", "R", "Immediate Restriction", "REM Duration (mins)",2.4,8)
plot2 = historyplot3("average_sleep_deviation_from_norm", "R", "Cumulative Restriction", "REM Duration (mins)",2.1,5)
plot3 = historyplot3("nightbefore_sleep_deviation_from_norm", "perR", "Immediate Restriction", "REM (% of TST)",2.3,10)
plot4 = historyplot3("average_sleep_deviation_from_norm", "perR", "Cumulative Restriction", "REM (% of TST)",2.1,8)
