...
```{r}
plot1 = historyplot3("nightbefore_sleep_deviation_from_norm", "N1", "Immediate Restriction", "N1 Duration (mins)",1.8,15)
plot2 = historyplot3("average_sleep_deviation_from_norm", "N1", "Cumulative Restriction", "N1 Duration (mins)",1.8,15)
plot3 = historyplot3("nightbefore_sleep_deviation_from_norm", "perN1", "Immediate Restriction", "N1 (% of TST)",1.8,18)
plot4 = historyplot3("average_sleep_deviation_from_norm", "perN1", "Cumulative Restriction", "N1 (% of TST)",1.8,20)
