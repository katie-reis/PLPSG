...
```{r}
PLPSG_sleep_stats_wider = PLPSG_sleep_stats_wider %>% mutate(FullCycle = ifelse(N3>0 & R>0, "FullCycle", "NoFullCycle"))
...
PLPSG_sleep_stats_wider$Subject[PLPSG_sleep_stats_wider$FullCycle == "FullCycle" & PLPSG_sleep_stats_wider$condition == "sleep"]
sum(PLPSG_sleep_stats_wider$FullCycle == "NoFullCycle" & PLPSG_sleep_stats_wider$condition == "sleep")
```
