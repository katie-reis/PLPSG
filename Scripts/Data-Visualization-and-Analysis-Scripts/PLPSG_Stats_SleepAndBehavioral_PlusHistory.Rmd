...
```{r}
# Correlation matrix
vars <- c("NightBefore_TST", "AverageSleep", "nightbefore_sleep_deviation_from_norm", "average_sleep_deviation_from_norm", "Pretest", "Posttest1", "Posttest2")
...
mediator_model <- lm(N3 ~ average_sleep_deviation_from_norm, data = PLPSG_sleep_stats_wider)

# Step 2: Model for outcome
outcome_model <- lm(recovery ~ N3 + average_sleep_deviation_from_norm, data = PLPSG_sleep_stats_wider)

# Step 3: Mediation analysis
med <- mediate(mediator_model, outcome_model, treat = "average_sleep_deviation_from_norm", mediator = "N3", boot = TRUE)
summary(med)
