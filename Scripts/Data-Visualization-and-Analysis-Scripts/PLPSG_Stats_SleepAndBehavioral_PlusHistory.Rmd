...
```{r}
lastepochfit = aov(recovery ~ last_sleep_epoch *N3_temporal_distance_from_waking2, data = subset( PLPSG_sleep_stats_wider, condition == "sleep"))
summary(lastepochfit)

lastepochfit = aov(recovery ~ N3_temporal_distance_from_waking2, data = subset( PLPSG_sleep_stats_wider, condition == "sleep"))
summary(lastepochfit)

corr <- cor.test(x=PLPSG_sleep_stats_wider$recovery, y=PLPSG_sleep_stats_wider$N3_temporal_distance_from_waking2, method = 'spearman')

mediantempdist = median(na.omit(PLPSG_sleep_stats_wider$N3_temporal_distance_from_waking2))
t.test(PLPSG_sleep_stats_wider$recovery[PLPSG_sleep_stats_wider$N3_temporal_distance_from_waking2 > mediantempdist],
       PLPSG_sleep_stats_wider$recovery[PLPSG_sleep_stats_wider$N3_temporal_distance_from_waking2 <= mediantempdist])

hist(as.numeric(PLPSG_sleep_stats_wider$N3_temporal_distance_from_waking2), breaks = 8)
(PLPSG_sleep_stats_wider$N3_temporal_distance_from_waking)
plot(x = PLPSG_sleep_stats_wider$N3_temporal_distance_from_waking2,
     y = PLPSG_sleep_stats_wider$recovery)
...
t.test(PLPSG_sleep_stats_wider$recovery[PLPSG_sleep_stats_wider$last_sleep_epoch == "N3" | PLPSG_sleep_stats_wider$last_sleep_epoch == "R" & PLPSG_sleep_stats_wider$condition == "sleep"],
       PLPSG_sleep_stats_wider$recovery[PLPSG_sleep_stats_wider$last_sleep_epoch != "N1" | PLPSG_sleep_stats_wider$last_sleep_epoch == "N2" & PLPSG_sleep_stats_wider$condition == "sleep"])

sum(na.omit(PLPSG_sleep_stats_wider$last_sleep_epoch == "N1"))
sum(na.omit(PLPSG_sleep_stats_wider$last_sleep_epoch == "N2"))
sum(na.omit(PLPSG_sleep_stats_wider$last_sleep_epoch == "N3"))
sum(na.omit(PLPSG_sleep_stats_wider$last_sleep_epoch == "R"))

sum(na.omit(PLPSG_sleep_stats_wider$last_sleep_epoch == "N1" & PLPSG_sleep_stats_wider$FullCycle == "FullCycle"))
sum(na.omit(PLPSG_sleep_stats_wider$last_sleep_epoch == "N2" & PLPSG_sleep_stats_wider$FullCycle == "FullCycle"))
sum(na.omit(PLPSG_sleep_stats_wider$last_sleep_epoch == "N3" & PLPSG_sleep_stats_wider$FullCycle == "FullCycle"))
sum(na.omit(PLPSG_sleep_stats_wider$last_sleep_epoch == "R" & PLPSG_sleep_stats_wider$FullCycle == "FullCycle"))

sum(na.omit(PLPSG_sleep_stats_wider$last_sleep_epoch == "N1" & PLPSG_sleep_stats_wider$FullCycle == "NoFullCycle"))
sum(na.omit(PLPSG_sleep_stats_wider$last_sleep_epoch == "N2" & PLPSG_sleep_stats_wider$FullCycle == "NoFullCycle"))
sum(na.omit(PLPSG_sleep_stats_wider$last_sleep_epoch == "N3" & PLPSG_sleep_stats_wider$FullCycle == "NoFullCycle"))
sum(na.omit(PLPSG_sleep_stats_wider$last_sleep_epoch == "R" & PLPSG_sleep_stats_wider$FullCycle == "NoFullCycle"))
```
...
#just for sleep subjects
```{r}
nightbeforemodel = lm(recovery ~ NightBefore_TST, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(nightbeforemodel)

avgsleepmodel = lm(recovery ~ AverageSleep, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(avgsleepmodel)

nightbeforedevmodel = lm(recovery ~ nightbefore_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(nightbeforedevmodel)

avgsleepdevmodel = lm(recovery ~ average_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(avgsleepdevmodel)
...
avgmodel = lm(maintenance ~ as.numeric(AverageSleep) * condition, data = subset(PLPSG_sleep_stats_wider))
summary(avgmodel)

nightbeforemodel = lm(maintenance ~ as.numeric(NightBefore_TST) * condition, data = subset(PLPSG_sleep_stats_wider))
summary(nightbeforemodel)
...
### does night before TST/ average TST predict N3 duration and %
```{r}
nightbeforemodel = lm(N3 ~ NightBefore_TST, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(nightbeforemodel)

avgsleepmodel = lm(N3 ~ AverageSleep, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(avgsleepmodel)


nightbeforemodelper = lm(perN3 ~ NightBefore_TST, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(nightbeforemodelper)

avgsleepmodelper = lm(perN3 ~ AverageSleep, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(avgsleepmodelper)


```

### now look at deviation from norm as opposed to TST 
```{r}
nightbeforedevmodel = lm(N3 ~ nightbefore_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(nightbeforedevmodel)

avgsleepdevmodel = lm(N3 ~ average_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(avgsleepdevmodel)

nightbeforedevmodelper = lm(perN3 ~ nightbefore_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(nightbeforedevmodelper)

avgsleepdevmodelper = lm(perN3 ~ average_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(avgsleepdevmodelper)

```

### now look at deviation from norm predicting N1 duration and %
```{r}
nightbeforedevmodel = lm(N1 ~ nightbefore_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(nightbeforedevmodel)

nightbeforedevmodelper = lm(perN1 ~ nightbefore_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(nightbeforedevmodelper)

avgsleepdevmodel = lm(N1 ~ average_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(avgsleepdevmodel)

avgsleepdevmodelper = lm(perN1 ~ average_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(avgsleepdevmodelper)

```


### now look at deviation from norm predicting N2 duration and %
```{r}
nightbeforedevmodel = lm(N2 ~ nightbefore_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(nightbeforedevmodel)

nightbeforedevmodelper = lm(perN2 ~ nightbefore_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(nightbeforedevmodelper)

avgsleepdevmodel = lm(N2 ~ average_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(avgsleepdevmodel)

avgsleepdevmodelper = lm(perN2 ~ average_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(avgsleepdevmodelper)

```

### now look at deviation from norm predicting R duration and %
```{r}
nightbeforedevmodel = lm(R ~ nightbefore_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(nightbeforedevmodel)

nightbeforedevmodelper = lm(perR ~ nightbefore_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(nightbeforedevmodelper)

avgsleepdevmodel = lm(R ~ average_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(avgsleepdevmodel)

avgsleepdevmodelper = lm(perR ~ average_sleep_deviation_from_norm, data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(avgsleepdevmodelper)
...
### 
```{r}
nightbeforemodel = lm(recovery ~ NightBefore_TST * (last_sleep_epoch == "N3"), data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(nightbeforemodel)

avgsleepmodel = lm(recovery ~ AverageSleep * (last_sleep_epoch == "N3"), data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(avgsleepmodel)

nightbeforedevmodel = lm(recovery ~ nightbefore_sleep_deviation_from_norm * (last_sleep_epoch == "N3"), data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(nightbeforedevmodel)

avgsleepdevmodel = lm(recovery ~ average_sleep_deviation_from_norm * (last_sleep_epoch == "N3"), data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))
summary(avgsleepdevmodel)


```

### mediation analysis - We then wanted to test whether SWS mediates the effect of sleep restriction on cognitive performance, and this could clarify why sleep restriction leads to changes in performance (via SWS rebound or lack thereof). As a result, we conducted a mediation analysis predicting recovery from cumulative sleep restriction, with the mediator of percentage of time spent in SWS. -- this isn't working
...
# Step 1: Model for mediator (SWS)
mediator_model <- lm(as.numeric(N3) ~ as.numeric(average_sleep_deviation_from_norm), data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))

# Step 2: Model for outcome
outcome_model <- lm(as.numeric(recovery) ~ as.numeric(N3) + as.numeric(average_sleep_deviation_from_norm), data = subset(PLPSG_sleep_stats_wider, condition == "sleep"))

# Step 3: Mediation analysis
med <- mediate(mediator_model, outcome_model, treat = as.numeric(average_sleep_deviation_from_norm), mediator = as.numeric(N3), boot = TRUE)
summary(med)


```
### We also performed a mixed-effects model to account for the repeated measures (pretest, posttest1, posttest2, posttest3, posttest4) within subjects and the nested structure of the data. This would allow us to isolate how performance changes across time and whether sleep history moderates that trajectory. In this model, we include random intercepts for subjects, and fixed effects for condition (sleep/wake), sleep metrics (NightBefore_TST, Cumulative Restriction), Time (pretest, posttest1, posttest2, posttest3, posttest4), and interactions (condition x time, sleep metrics x time).
```{r}
install.packages("lme4")
install.packages("lmerTest")  # for p-values
install.packages("emmeans")   # optional: for estimated marginal means

library(lme4)
library(lmerTest)

PLPSG_sleep_stats_longer$block <- factor(PLPSG_sleep_stats_longer$block)
PLPSG_sleep_stats_longer$Condition <- factor(PLPSG_sleep_stats_longer$condition)

model <- lmer(
  score ~ condition * block +
    NightBefore_TST * block +
    AverageSleep * block +
    nightbefore_sleep_deviation_from_norm * block +
    average_sleep_deviation_from_norm * block +
    (1 | Subject),
  data = PLPSG_sleep_stats_longer
)

summary(model)
```
### are sleep and wake subjects matched on their sleep debt?
```{r}
PLPSG_sleep_stats_wider$average_sleep_deviation_from_norm = as.numeric(PLPSG_sleep_stats_wider$average_sleep_deviation_from_norm)
PLPSG_sleep_stats_wider$nightbefore_sleep_deviation_from_norm = as.numeric(PLPSG_sleep_stats_wider$nightbefore_sleep_deviation_from_norm)
t.test(PLPSG_sleep_stats_wider$nightbefore_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "sleep"],
       PLPSG_sleep_stats_wider$nightbefore_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "wake"])

t.test(PLPSG_sleep_stats_wider$average_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "sleep"],
       PLPSG_sleep_stats_wider$average_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "wake"])

```

### are stanford sleepiness scale results comparable across groups 
```{r}
t.test(PLPSG_sleep_stats_wider$SS_BeforeBlock1[PLPSG_sleep_stats_wider$condition == "sleep"],
       PLPSG_sleep_stats_wider$SS_BeforeBlock1[PLPSG_sleep_stats_wider$condition == "wake"])

t.test(PLPSG_sleep_stats_wider$SS_BeforeBlock4[PLPSG_sleep_stats_wider$condition == "sleep"],
       PLPSG_sleep_stats_wider$SS_BeforeBlock4[PLPSG_sleep_stats_wider$condition == "wake"])

t.test(PLPSG_sleep_stats_wider$SS_BeforeBlock5[PLPSG_sleep_stats_wider$condition == "sleep"],
       PLPSG_sleep_stats_wider$SS_BeforeBlock5[PLPSG_sleep_stats_wider$condition == "wake"])

t.test(PLPSG_sleep_stats_wider$SS_BeforeBlock6[PLPSG_sleep_stats_wider$condition == "sleep"],
       PLPSG_sleep_stats_wider$SS_BeforeBlock6[PLPSG_sleep_stats_wider$condition == "wake"])

#SDs and SEs
sd(PLPSG_sleep_stats_wider$SS_BeforeBlock1[PLPSG_sleep_stats_wider$condition == "sleep"])
sd(PLPSG_sleep_stats_wider$SS_BeforeBlock1[PLPSG_sleep_stats_wider$condition == "wake"])
print(std.error(PLPSG_sleep_stats_wider$SS_BeforeBlock1[PLPSG_sleep_stats_wider$condition == "sleep"]))
print(std.error(PLPSG_sleep_stats_wider$SS_BeforeBlock1[PLPSG_sleep_stats_wider$condition == "wake"]))

sd(PLPSG_sleep_stats_wider$SS_BeforeBlock4[PLPSG_sleep_stats_wider$condition == "sleep"])
sd(PLPSG_sleep_stats_wider$SS_BeforeBlock4[PLPSG_sleep_stats_wider$condition == "wake"])
print(std.error(PLPSG_sleep_stats_wider$SS_BeforeBlock4[PLPSG_sleep_stats_wider$condition == "sleep"]))
print(std.error(PLPSG_sleep_stats_wider$SS_BeforeBlock4[PLPSG_sleep_stats_wider$condition == "wake"]))

sd(PLPSG_sleep_stats_wider$SS_BeforeBlock5[PLPSG_sleep_stats_wider$condition == "sleep"])
sd(PLPSG_sleep_stats_wider$SS_BeforeBlock5[PLPSG_sleep_stats_wider$condition == "wake"])
print(std.error(PLPSG_sleep_stats_wider$SS_BeforeBlock5[PLPSG_sleep_stats_wider$condition == "sleep"]))
print(std.error(PLPSG_sleep_stats_wider$SS_BeforeBlock5[PLPSG_sleep_stats_wider$condition == "wake"]))

sd(PLPSG_sleep_stats_wider$SS_BeforeBlock6[PLPSG_sleep_stats_wider$condition == "sleep"])
sd(PLPSG_sleep_stats_wider$SS_BeforeBlock6[PLPSG_sleep_stats_wider$condition == "wake"])
print(std.error(PLPSG_sleep_stats_wider$SS_BeforeBlock6[PLPSG_sleep_stats_wider$condition == "sleep"]))
print(std.error(PLPSG_sleep_stats_wider$SS_BeforeBlock6[PLPSG_sleep_stats_wider$condition == "wake"]))
```

#and if SSS impacts performance
```{r}
baseline = aov(block1 ~ SS_BeforeBlock1 *condition, data = subset( PLPSG_sleep_stats_wider))
summary(baseline)

learningfit = aov(learning ~ SS_BeforeBlock1 *condition, data = subset( PLPSG_sleep_stats_wider))
summary(learningfit)

lossfit = aov(loss ~ SS_BeforeBlock4 *condition, data = subset( PLPSG_sleep_stats_wider))
summary(lossfit)

#this might not be the best way of handling this though let's check out a regression - this is what we end up using for dissertation
model <- lm(loss ~ SS_BeforeBlock4 * condition, data = PLPSG_sleep_stats_wider)
summary(model)
...
recoveryfit = aov(recovery ~ SS_BeforeBlock5  *condition, data = subset( PLPSG_sleep_stats_wider))
summary(recoveryfit)

#also used for dissertation - lm not aov
maintenancefit = aov(maintenance ~ SS_BeforeBlock6  *condition, data = subset( PLPSG_sleep_stats_wider))
summary(maintenancefit)

model <- lm(maintenance ~ SS_BeforeBlock6 * condition, data = PLPSG_sleep_stats_wider)
summary(model)

ggplot(data = subset(PLPSG_sleep_stats_wider)) + 
  aes(x = SS_BeforeBlock1, y = learning, color = condition,
      na.rm = TRUE) +
  xlab("SS Before Block 1") + 
  ylab("learning") +
...
ggplot(data = subset(PLPSG_sleep_stats_wider)) + 
  aes(x = SS_BeforeBlock4, y = loss, color = condition,
      na.rm = TRUE) +
  xlab("SS Before Block 4") + 
  ylab("loss") +
  theme(axis.title.x = element_text(size=9), axis.title.y = element_text(size=9)) +
  geom_point() +
  geom_smooth(method = "lm", se = FALSE)

fit = lm(loss ~ condition, data = PLPSG_sleep_stats_wider)
summary(fit)
```
#is there a diff in sleep architecture 
```{r}
fit = aov(N1 ~ SS_BeforeBlock4, data = subset( PLPSG_sleep_stats_wider, condition == "sleep"))
summary(fit)

fit = aov(N2 ~ SS_BeforeBlock4, data = subset( PLPSG_sleep_stats_wider, condition == "sleep"))
summary(fit)

fit = aov(N3 ~ SS_BeforeBlock4, data = subset( PLPSG_sleep_stats_wider, condition == "sleep"))
summary(fit)


fit = aov(R ~ SS_BeforeBlock4, data = subset( PLPSG_sleep_stats_wider, condition == "sleep"))
summary(fit)


fit = aov(TST ~ SS_BeforeBlock4, data = subset( PLPSG_sleep_stats_wider, condition == "sleep"))
summary(fit)

ggplot(data = subset(PLPSG_sleep_stats_wider, condition == "sleep")) + 
  aes(x = SS_BeforeBlock4, y = as.numeric(TST),
      na.rm = TRUE) +
  xlab("SS Before Block 4") + 
  ylab("TST") +
  theme(axis.title.x = element_text(size=9), axis.title.y = element_text(size=9)) +
...
### sd of last sleep epoch effect on recovery
```{r}
sd(PLPSG_sleep_stats_wider$recovery[PLPSG_sleep_stats_wider$condition == "sleep" & PLPSG_sleep_stats_wider$last_sleep_epoch == "N3"])
sd(PLPSG_sleep_stats_wider$recovery[PLPSG_sleep_stats_wider$condition == "sleep" & PLPSG_sleep_stats_wider$last_sleep_epoch != "N3"])

```

### how nap and wake differ on sleep history measures 
```{r}
t.test(PLPSG_sleep_stats_wider$NightBefore_TST[PLPSG_sleep_stats_wider$condition == "sleep"],
       PLPSG_sleep_stats_wider$NightBefore_TST[PLPSG_sleep_stats_wider$condition == "wake"])
sd(PLPSG_sleep_stats_wider$NightBefore_TST[PLPSG_sleep_stats_wider$condition == "sleep"])
sd(PLPSG_sleep_stats_wider$NightBefore_TST[PLPSG_sleep_stats_wider$condition == "wake"])
#se
print(std.error(PLPSG_sleep_stats_wider$NightBefore_TST[PLPSG_sleep_stats_wider$condition == "sleep"]))
print(std.error(PLPSG_sleep_stats_wider$NightBefore_TST[PLPSG_sleep_stats_wider$condition == "wake"]))

t.test(PLPSG_sleep_stats_wider$AverageSleep[PLPSG_sleep_stats_wider$condition == "sleep"],
       PLPSG_sleep_stats_wider$AverageSleep[PLPSG_sleep_stats_wider$condition == "wake"])
sd(PLPSG_sleep_stats_wider$AverageSleep[PLPSG_sleep_stats_wider$condition == "sleep"])
sd(PLPSG_sleep_stats_wider$AverageSleep[PLPSG_sleep_stats_wider$condition == "wake"])
print(std.error(PLPSG_sleep_stats_wider$AverageSleep[PLPSG_sleep_stats_wider$condition == "sleep"]))
print(std.error(PLPSG_sleep_stats_wider$AverageSleep[PLPSG_sleep_stats_wider$condition == "wake"]))

t.test(PLPSG_sleep_stats_wider$nightbefore_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "sleep"],
       PLPSG_sleep_stats_wider$nightbefore_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "wake"])
sd(PLPSG_sleep_stats_wider$nightbefore_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "sleep"])
sd(PLPSG_sleep_stats_wider$nightbefore_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "wake"])
print(std.error(PLPSG_sleep_stats_wider$nightbefore_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "sleep"]))
print(std.error(PLPSG_sleep_stats_wider$nightbefore_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "wake"]))

t.test(PLPSG_sleep_stats_wider$average_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "sleep"],
       PLPSG_sleep_stats_wider$average_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "wake"])
sd(PLPSG_sleep_stats_wider$average_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "sleep"])
sd(PLPSG_sleep_stats_wider$average_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "wake"])
print(std.error(PLPSG_sleep_stats_wider$average_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "sleep"]))
print(std.error(PLPSG_sleep_stats_wider$average_sleep_deviation_from_norm[PLPSG_sleep_stats_wider$condition == "wake"]))
